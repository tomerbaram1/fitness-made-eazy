  ...
  return (
    <div>
      ...
      <div className="card-container1">
        ...
        {selectedProgram === "Upper Body Workout" ? <ActionAreaCard title="Upper Body Workouts That Get Results" text2="The Best Upper Body Workout Plan: Pack On Lean Size Across Your Torso" text="Do you want to add a serious amount of lean muscle mass in just 28 days? Then you’ve come to the right place because this four-week, 16-session upper body workout plan will do exactly that by pushing your body harder than it’s ever been pushed before. After all, getting out of your comfort zone and doing something you’ve not done before is the key to making rapid progress." /> : <div />}
        {selectedProgram === "Core" ? <ActionAreaCard title="GET YOUR SELF ABS  LIKE WE HAVE" text2="Your core muscles are mobilized in flexion, extension, rotation, abdominal bracing, pelvic tilting, and even the way your shoulder blades move,” certified personal trainer Brian Abarca, CPT, owner of Abarca Fitness in New Jersey, tells SELF. “People usually think of abs when referring to the core, but our core is actually made up of a much more complex network of muscles found in the trunk of our body.”." text="Although you may think of your “core” only when you’re doing specific abs moves, you actually use these muscles all day, every day—which is why core exercises are so important. Whether you’re walking, reaching, balancing, getting up from a chair, or simply just standing upright, the muscles of your midsection are firing to keep you stable and supported in nearly every movement." /> : <div />}
        {selectedProgram === "Crossfit" ? <ActionAreaCard title="CrossFit Overview: Systematic Review and Meta-analysis" text2="Thirty-one articles were included in the systematic review and four were included in the meta-analysis. However, only two studies had a high level of evidence at low risk of bias. Scientific literature related to CrossFit has reported on body composition, psycho-physiological parameters, musculoskeletal injury risk, life and health aspects, and psycho-social behavior. In the meta-analysis, significant results were not found for any variables." text="Systematic searches of the PubMed, Web of Science, Scopus, Bireme/MedLine, and SciELO online databases were conducted for articles reporting the effects of CrossFit training. The systematic review followed the PRISMA guidelines. The Oxford Levels of Evidence was used for all included articles, and only studies that investigated the effects of CrossFit as a training program were included in the meta-analysis. For the meta-analysis, effect sizes (ESs) with 95% confidence interval (CI) were calculated and heterogeneity was assessed using a random-effects model." /> : <div />}
